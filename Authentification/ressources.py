...
class EmployeResource(resources.ModelResource):
    ...
    date_naissance = fields.Field(column_name='Date de naissance', attribute='date_naissance',
    ...
    nationalite_paie = fields.Field(column_name='Nationalité paie', attribute='nationalite_paie',
                                    widget=widgets.CharWidget())
    situation_famille = fields.Field(column_name='Situation de famille', attribute='situation_famille',
                                     widget=widgets.CharWidget())
    ...
    date_entree = fields.Field(column_name='Date d entré', attribute='date_entree',
                               widget=widgets.DateWidget(format('%d-%m-%Y')))
    date_anciennete = fields.Field(column_name='Date d ancienneté', attribute='date_anciennete',
                                   widget=widgets.DateWidget(format('%d-%m-%Y')))
    type_base_salariale = fields.Field(column_name='Type base salariale', attribute='type_base_salariale')
    mode_reglement = fields.Field(column_name='Mode de réglement', attribute='mode_reglement',
                                  widget=widgets.CharWidget())
    ...
    code_edition_comm = fields.Field(column_name='Code edition comm.', attribute='code_edition_comm',
                                     widget=widgets.IntegerWidget())
    code_agent = fields.Field(column_name='Code agent', attribute='code_agente', widget=widgets.IntegerWidget())
    date_sortie = fields.Field(column_name='Date sortie', attribute='date_sortie',
                               widget=widgets.DateWidget(format('%d-%m-%Y')))
    superieur_hierarchique = fields.Field(column_name='Supérieur hiérarchique', attribute='superieur_hierarchique',
    ...
    date_fin_contrat = fields.Field(column_name='Date fin contrat', attribute='date_fin_contrat',
    ...
    department = fields.Field(column_name='Département', attribute='department',
                              widget=widgets.ForeignKeyWidget(Departement))
    activite = fields.Field(column_name='Activité', attribute='activite', widget=widgets.ForeignKeyWidget(Activite))
    cost_center = fields.Field(column_name='Cost Center', attribute='cost_center',
                               widget=widgets.ForeignKeyWidget(CostCenter))

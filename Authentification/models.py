...
class Employe(AbstractBaseUser):
    ...
    matricule_paie = models.IntegerField(unique=True, null=True, blank=True, verbose_name='Matricule Paie')
    ...
    n_cin = models.CharField(max_length=10, unique=True, verbose_name='Numero Cin', null=False)
